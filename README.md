...
## Project Maintainers
The designated local VATGlasses maintainer for each vACC will be given access to this repository, the repository for the Beta site, and the private areas of our Discord server.

If you're currently a local VATGlasses maintainer without access, please open an issue or request access on the Discord server.

All maintainers have permission to approve changes by other maintainers. All PRs require at least one approval before merging.
...
All PRs require approval from at least one maintainer before merging. Changes should be tested on the Beta site before opening a PR.

**N.B.** Data committed to this repository is immediately deployed to the VATGlasses site - please expect the maintainers to be picky and test things thoroughly before we approve them!
